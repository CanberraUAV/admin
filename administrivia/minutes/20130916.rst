 ...
 * Need a plane to test automatic take off and landing suitable for rural location e.g. can handle the rough strip.  Also if we crash it how long to get a replacement in the air.
 ...
 * Stefan Gofferje from Finland - working with UAVs in Finland.  Testing Thermal cameras.  Most clothing has a different degree of reflectivity in near infra-red then most other substances.  With colour version of a camera the pattern of colour you get from manufactured clothing then surround terrain.  People wearing camouflage gear very low thermal signature but cheap knock off can be spotted easily on near infrared.
